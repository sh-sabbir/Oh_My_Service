...
import com.codeian.ohmyservice.serviceprovider.OrderDetails;
...
public class OrderListingAdapterSP extends RecyclerView.Adapter<OrderListingAdapterSP.ViewHolder> {
    ...
    public OrderListingAdapterSP(Map<String, Object> availableListing, Context context) {
        mData = new ArrayList();
    ...
    @Override
    public OrderListingAdapterSP.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final OrderListingAdapterSP.ViewHolder viewHolder, final  int i) {
